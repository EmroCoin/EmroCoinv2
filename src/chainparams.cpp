...
public:
	CMainParams() {
		...
		genesis.nVersion = 1;
		genesis.nTime = 1529432617;
		genesis.nBits = 520159231;
		genesis.nNonce = 69951;

		hashGenesisBlock = genesis.GetHash();

		assert(genesis.hashMerkleRoot == uint256("0x2e1e23a460289590c512675dbef0ddc2e8f2c8bf03f71193e437fae5cb5c0b63"));
		assert(hashGenesisBlock == uint256("0x000045a8da748e311b35e9623415495d5bb86fbdc96922c58d1f1c50f62b8ae0"));
		...
		vSeeds.push_back(CDNSSeedData("1", "104.207.134.111"));
        	...
        	vSeeds.push_back(CDNSSeedData("3", "208.167.248.53"));
